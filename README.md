    ...
    <div class="chat-container" id="chatContainer">
        ...
        <div class="chat-footer">
            ...
            <div class="chat-controls">
                <button class="control-btn emoji-btn" id="emojiBtn" title="Emoji">😀</button>
                <button class="control-btn" id="userListBtn" title="Daftar User">👥</button>
                <button class="control-btn" id="clearChatBtn" title="Hapus Chat">🗑️</button>
            </div>
